             ...
             {meta.links && meta.links.map((link,ind)=>(
              ...
              //  active={!link.url ? 'true' :'false'}
               className={
                ...
                +(link.active ? 'border-blue-500 bg-blue-50 ' :'')
                +(!link.url ? 'border-gray-300 rounded-l-md bg-gray-100 hover:bg-gray-100' :'')
                +(link.url ? 'hover:bg-blue-100 hover:border-blue-400' :'')
              }
